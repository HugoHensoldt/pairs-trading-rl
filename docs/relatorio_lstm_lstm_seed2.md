# Relatório LSTM — experimento `lstm_seed2`
...
- **Compra**: AUC no teste = **0.603** em média entre 5 fold(s) (desvio 0.006; mín 0.594, máx 0.607); 5 de 5 folds acima de 0,5. Último fold: 0.606 [0.597; 0.619] (IC95% por bootstrap sobre os pregões). Acurácia no teste menos a do classificador majoritário: +0.077 (média). Referências: AUC de um score que só conhece a combinação (sigma, Re, Ri) = 0.634; AUC do modelo apenas dentro de cada combinação = 0.490.
- **Venda**: AUC no teste = **0.623** em média entre 5 fold(s) (desvio 0.006; mín 0.614, máx 0.629); 5 de 5 folds acima de 0,5. Último fold: 0.614 [0.594; 0.632] (IC95% por bootstrap sobre os pregões). Acurácia no teste menos a do classificador majoritário: +0.088 (média). Referências: AUC de um score que só conhece a combinação (sigma, Re, Ri) = 0.640; AUC do modelo apenas dentro de cada combinação = 0.510.
...
![Balanceamento buy](img/lstm_lstm_seed2_fig1_balanco_buy.png)

![Balanceamento sell](img/lstm_lstm_seed2_fig2_balanco_sell.png)
...
![Loss](img/lstm_lstm_seed2_fig3_curva_loss.png)
...
![Acurácia](img/lstm_lstm_seed2_fig4_curva_acuracia.png)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Compra | 1 | 9 | 1 | 24438 | 33445 | 20301 | 0.601 | 0.594 | [0.576; 0.610] | 0.634 | 0.503 | 0.572 | 0.500 | 0.572 | 0.573 | 0.565 | 0.365 |
| Compra | 2 | 9 | 1 | 57883 | 24987 | 20301 | 0.603 | 0.604 | [0.588; 0.622] | 0.634 | 0.499 | 0.580 | 0.500 | 0.580 | 0.578 | 0.589 | 0.610 |
| Compra | 3 | 9 | 1 | 82870 | 27235 | 20301 | 0.614 | 0.607 | [0.594; 0.618] | 0.634 | 0.482 | 0.579 | 0.500 | 0.579 | 0.575 | 0.604 | 0.822 |
| Compra | 4 | 9 | 1 | 110105 | 33947 | 20301 | 0.639 | 0.606 | [0.592; 0.618] | 0.634 | 0.488 | 0.577 | 0.500 | 0.577 | 0.570 | 0.624 | 1.025 |
| Compra | 5 | 9 | 1 | 144052 | 25431 | 20301 | 0.635 | 0.606 | [0.597; 0.619] | 0.634 | 0.478 | 0.578 | 0.500 | 0.578 | 0.576 | 0.593 | 1.307 |
| Venda | 1 | 9 | 1 | 23461 | 30534 | 18273 | 0.601 | 0.620 | [0.604; 0.638] | 0.640 | 0.509 | 0.595 | 0.504 | 0.596 | 0.615 | 0.526 | 0.355 |
| Venda | 2 | 9 | 1 | 53995 | 25931 | 18273 | 0.628 | 0.629 | [0.614; 0.643] | 0.640 | 0.510 | 0.596 | 0.504 | 0.597 | 0.619 | 0.518 | 0.567 |
| Venda | 3 | 9 | 1 | 79926 | 29182 | 18273 | 0.603 | 0.627 | [0.612; 0.642] | 0.640 | 0.512 | 0.598 | 0.504 | 0.599 | 0.634 | 0.477 | 0.808 |
| Venda | 4 | 9 | 1 | 109108 | 30980 | 18273 | 0.626 | 0.625 | [0.608; 0.642] | 0.640 | 0.509 | 0.591 | 0.504 | 0.592 | 0.612 | 0.514 | 1.017 |
| Venda | 5 | 10 | 2 | 140088 | 24952 | 18273 | 0.630 | 0.614 | [0.594; 0.632] | 0.640 | 0.508 | 0.581 | 0.504 | 0.581 | 0.578 | 0.628 | 1.412 |
...
![AUC por fold](img/lstm_lstm_seed2_fig5_auc_por_fold.png)

### Curva ROC

![ROC por fold](img/lstm_lstm_seed2_fig6_roc_por_fold.png)

![ROC treino/val/teste](img/lstm_lstm_seed2_fig7_roc_treino_val_teste.png)
...
![Matriz de confusão](img/lstm_lstm_seed2_fig8_matriz_confusao_teste.png)
...
![Lift](img/lstm_lstm_seed2_fig9_lift_teste.png)

### Calibração

![Calibração](img/lstm_lstm_seed2_fig10_calibracao_teste.png)
...
![AUC por combinação buy](img/lstm_lstm_seed2_fig11_auc_combo_buy.png)

![AUC por combinação sell](img/lstm_lstm_seed2_fig12_auc_combo_sell.png)
...
```
python src/report_lstm.py --run-dir sdumont_backup_lstm/lstm_runs --tag lstm_seed2
```
