# Relatório LSTM — experimento `lstm_v2_base`
...
- **Compra**: AUC no teste = **0.612** em média entre 5 fold(s) (desvio 0.020; mín 0.578, máx 0.630); 5 de 5 folds acima de 0,5. Último fold: 0.630 [0.617; 0.643] (IC95% por bootstrap sobre os pregões). Acurácia no teste menos a do classificador majoritário: +0.048 (média). Referências: AUC de um score que só conhece a combinação (sigma, Re, Ri) = 0.642; AUC do modelo apenas dentro de cada combinação = 0.513.
- **Venda**: AUC no teste = **0.599** em média entre 5 fold(s) (desvio 0.018; mín 0.568, máx 0.613); 5 de 5 folds acima de 0,5. Último fold: 0.613 [0.600; 0.628] (IC95% por bootstrap sobre os pregões). Acurácia no teste menos a do classificador majoritário: +0.052 (média). Referências: AUC de um score que só conhece a combinação (sigma, Re, Ri) = 0.631; AUC do modelo apenas dentro de cada combinação = 0.507.
...
![Balanceamento buy](img/lstm_lstm_v2_base_fig1_balanco_buy.png)

![Balanceamento sell](img/lstm_lstm_v2_base_fig2_balanco_sell.png)
...
![Loss](img/lstm_lstm_v2_base_fig3_curva_loss.png)
...
![Acurácia](img/lstm_lstm_v2_base_fig4_curva_acuracia.png)
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| Compra | 1 | 9 | 1 | 11698 | 14290 | 25286 | 0.595 | 0.578 | [0.557; 0.599] | 0.642 | 0.506 | 0.555 | 0.531 | 0.551 | 0.577 | 0.614 | 0.260 |
| Compra | 2 | 9 | 1 | 25988 | 11469 | 25286 | 0.590 | 0.618 | [0.604; 0.634] | 0.642 | 0.525 | 0.576 | 0.531 | 0.586 | 0.655 | 0.426 | 0.363 |
| Compra | 3 | 9 | 1 | 37457 | 11442 | 25286 | 0.592 | 0.613 | [0.601; 0.629] | 0.642 | 0.502 | 0.583 | 0.531 | 0.584 | 0.616 | 0.572 | 0.393 |
| Compra | 4 | 9 | 1 | 48899 | 10732 | 25286 | 0.592 | 0.622 | [0.608; 0.633] | 0.642 | 0.506 | 0.588 | 0.531 | 0.594 | 0.643 | 0.505 | 0.480 |
| Compra | 5 | 9 | 1 | 59631 | 13830 | 25286 | 0.620 | 0.630 | [0.617; 0.643] | 0.642 | 0.524 | 0.596 | 0.531 | 0.599 | 0.639 | 0.551 | 0.597 |
| Venda | 1 | 9 | 1 | 11221 | 13093 | 23688 | 0.565 | 0.568 | [0.544; 0.590] | 0.631 | 0.497 | 0.535 | 0.518 | 0.541 | 0.581 | 0.367 | 0.260 |
| Venda | 2 | 9 | 1 | 24314 | 11913 | 23688 | 0.623 | 0.598 | [0.577; 0.618] | 0.631 | 0.508 | 0.571 | 0.518 | 0.574 | 0.607 | 0.492 | 0.352 |
| Venda | 3 | 9 | 1 | 36227 | 11827 | 23688 | 0.622 | 0.610 | [0.593; 0.628] | 0.631 | 0.516 | 0.584 | 0.518 | 0.581 | 0.589 | 0.648 | 0.392 |
| Venda | 4 | 9 | 1 | 48054 | 12103 | 23688 | 0.593 | 0.606 | [0.592; 0.621] | 0.631 | 0.505 | 0.581 | 0.518 | 0.582 | 0.604 | 0.557 | 0.478 |
| Venda | 5 | 9 | 1 | 60157 | 13010 | 23688 | 0.632 | 0.613 | [0.600; 0.628] | 0.631 | 0.508 | 0.581 | 0.518 | 0.580 | 0.594 | 0.605 | 0.580 |
...
![AUC por fold](img/lstm_lstm_v2_base_fig5_auc_por_fold.png)

### Curva ROC

![ROC por fold](img/lstm_lstm_v2_base_fig6_roc_por_fold.png)

![ROC treino/val/teste](img/lstm_lstm_v2_base_fig7_roc_treino_val_teste.png)
...
![Matriz de confusão](img/lstm_lstm_v2_base_fig8_matriz_confusao_teste.png)
...
![Lift](img/lstm_lstm_v2_base_fig9_lift_teste.png)

### Calibração

![Calibração](img/lstm_lstm_v2_base_fig10_calibracao_teste.png)
...
![AUC por combinação buy](img/lstm_lstm_v2_base_fig11_auc_combo_buy.png)

![AUC por combinação sell](img/lstm_lstm_v2_base_fig12_auc_combo_sell.png)
...
![Comparação](img/lstm_lstm_v2_base_fig13_comparacao_experimentos.png)
...
```
python src/report_lstm.py --run-dir sdumont_backup_lstm/lstm_runs --tag lstm_v2_base --compare
```
